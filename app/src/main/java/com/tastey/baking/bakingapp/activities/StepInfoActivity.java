...
public class StepInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String recipes_json = getIntent().getExtras().getString(DetailFragment.STEP_INFO_EXTRA);
        ...
        mSectionsPagerAdapter = new SectionsPagerAdapter(getSupportFragmentManager(), recipeModel.getSteps());
